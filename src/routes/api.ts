...
Route.delete('/unsafe-file/:fileId', AuthMiddleware.verifyToken, AuthMiddleware.restrictTo('user'), UploadsController.unsafeFile);
Route.post('/create-folder', AuthMiddleware.verifyToken, UploadsController.createFolder);
Route.get('/download-file/:fileId', UploadsController.downloadFile);
